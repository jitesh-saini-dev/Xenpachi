    ...
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-8 relative overflow-hidden font-serif">
      ...
      <div className="relative z-10 max-w-3xl w-full text-center space-y-10">
        ...
        <h1 className="text-6xl md:text-8xl font-black italic tracking-tighter uppercase">
          Latest <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-500 to-white">Drops</span>
        </h1>

        {/* Description */}
        <p className="text-xl md:text-2xl leading-relaxed text-gray-400 max-w-2xl mx-auto font-light">
          The <span className="text-white font-bold italic">Winter Collection</span> is loading. 
          Get exclusive early access before the masses. Keep your eyes peeled.
        </p>

        {/* Newsletter Subscription Form */}
        {!subscribed ? (
          <form onSubmit={handleSubscribe} className="mt-12 flex flex-col sm:flex-row gap-0 max-w-lg mx-auto w-full border-2 border-zinc-800 focus-within:border-white transition-colors">
            <input 
              type="email" 
              required
