...
//   return (
//     <div className="relative min-h-[90vh] bg-white text-black overflow-hidden flex flex-col items-center">
//       {/* Massive Background Title */}
//       <div className="w-full text-center mt-10 z-0 absolute top-0">
//         <h1 className="text-[10vw] font-black tracking-tight leading-none">
//           Xenpachi Aesthetics
//         </h1>
//       </div>

//       {/* Zigzag Image Gallery - Ekdum Static (No Add to Cart Overlay) */}
//       <div className="relative z-10 flex justify-center items-center gap-4 lg:gap-8 mt-[15vw] px-10 w-full max-w-7xl">
//         {products.map((item) => (
//           <div
//             key={item.id}
//             className={`relative group w-1/4 max-w-[260px] aspect-[3/4] rounded-[2.5rem] overflow-hidden bg-gray-200 shadow-xl ${item.offset}`}
//           >
//             <img
//               src={item.src}
//               alt={item.name}
...
// -------animate slo-mo--------------
import { useNavigate } from "react-router-dom";
// Baaki components ko import kar liya
