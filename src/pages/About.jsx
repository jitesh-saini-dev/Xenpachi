      ...
      <div className="relative z-10 max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-16 items-center mt-10 md:mt-0">
        ...
        <div className="space-y-8 z-20">
          ...
          <p className="text-2xl leading-relaxed text-gray-300 font-light">
            Xenpachi is not just a brand; it's a <span className="text-white font-bold italic">movement</span>. 
            Born in the streets, crafted for the aesthetic.
          </p>
          
          <p className="text-lg text-gray-400 leading-relaxed border-l-4 border-gray-600 pl-4">
            We blend premium 100% cotton with designs that speak louder than words. 
            Every thread, every drop is meant to break the matrix.
          </p>
